...
<aside class="dashboard-sidebar" id="dashboardSidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            ...
            <!-- Courses & Batches -->
            <li class="nav-item">
                <a href="#" class="nav-link has-submenu ${param.activePage == 'courses' || param.activePage == 'create-course' || param.activePage == 'all-courses' || param.activePage == 'assign-teachers' || param.activePage == 'manage-batches' || param.activePage == 'study-materials' ? 'active' : ''}" data-bs-toggle="collapse" data-bs-target="#coursesMenu">
                    <i class="bi bi-book"></i>
                    <span>Courses & Batches</span>
                    <i class="bi bi-chevron-down submenu-arrow"></i>
                </a>
                <ul class="submenu collapse ${param.activePage == 'courses' || param.activePage == 'create-course' || param.activePage == 'all-courses' || param.activePage == 'assign-teachers' || param.activePage == 'manage-batches' || param.activePage == 'study-materials' ? 'show' : ''}" id="coursesMenu">
